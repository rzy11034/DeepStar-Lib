...
type
  ...
  public
    ...
    function Ceiling(e: K): IPtrValue_K;
...
function TTreeMap.Ceiling(e: K): IPtrValue_K;
var
  temp: TImpl_K.TArr;
  l, r, mid: integer;
begin
...
begin
  ...
  if temp = nil then
  begin
    str := 'There is no ''' + string(Value.ToString) + '''';
    raise Exception.Create(str.ToAnsiString);
  end;
...
begin
  ...
  if temp = nil then
  begin
    str := 'There is no ''' + string(val.ToString) + '''';
    raise Exception.Create(str.ToAnsiString);
  end;
