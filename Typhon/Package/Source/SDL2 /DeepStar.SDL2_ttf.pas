...
*}
procedure TTF_ByteSwappedUNICODE(swapped: integer) cdecl;
...
function TTF_OpenFont(_file: pansichar; ptsize: integer): PTTF_Font cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_OpenFont' {$ENDIF} {$ENDIF};
function TTF_OpenFontIndex(_file: pansichar; ptsize: integer; index: longint): PTTF_Font cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_OpenFontIndex' {$ENDIF} {$ENDIF};
function TTF_OpenFontRW(src: PSDL_RWops; freesrc: integer; ptsize: longint): PTTF_Font cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_OpenFontRW' {$ENDIF} {$ENDIF};
function TTF_OpenFontIndexRW(src: PSDL_RWops; freesrc: integer; ptsize: integer; index: longint): PTTF_Font cdecl;
...
function TTF_GetFontOutline(font: PTTF_Font): integer cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_GetFontOutline' {$ENDIF} {$ENDIF};
procedure TTF_SetFontOutline(font: PTTF_Font; outline: integer) cdecl;
...
function TTF_GetFontHinting(font: PTTF_Font): integer cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_GetFontHinting' {$ENDIF} {$ENDIF};
procedure TTF_SetFontHinting(font: PTTF_Font; hinting: integer) cdecl;
...
function TTF_GetFontKerning(font: PTTF_Font): integer cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_GetFontKerning' {$ENDIF} {$ENDIF};
procedure TTF_SetFontKerning(font: PTTF_Font; allowed: integer) cdecl;
...
function TTF_GlyphIsProvided(font: PTTF_Font; ch: uint16): integer cdecl;
...
function TTF_GlyphMetrics(font: PTTF_Font; ch: uint16;
  minx, maxx: PInt;
  miny, maxy: PInt; advance: PInt): integer cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_GlyphMetrics' {$ENDIF} {$ENDIF};

{* Get the dimensions of a rendered string of text *}
function TTF_SizeText(font: PTTF_Font; Text: pansichar; w, h: PInt): integer cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_SizeText' {$ENDIF} {$ENDIF};
function TTF_SizeUTF8(font: PTTF_Font; Text: pansichar; w, h: PInt): integer cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_SizeUTF8' {$ENDIF} {$ENDIF};
function TTF_SizeUNICODE(font: PTTF_Font; Text: PUInt16; w, h: PInt): integer cdecl;
...
function TTF_RenderUNICODE_Solid(font: PTTF_Font; Text: PUInt16; fg: TSDL_Color): PSDL_Surface cdecl;
...
{* Create an 8-bit palettized surface and render the given glyph at
   ...
   This function returns the new surface, or NULL if there was an error.
*}
function TTF_RenderGlyph_Solid(font: PTTF_Font; ch: uint16; fg: TSDL_Color): PSDL_Surface cdecl;
...
{* Create an 8-bit palettized surface and render the given text at
   ...
   This function returns the new surface, or NULL if there was an error.
*}
function TTF_RenderText_Shaded(font: PTTF_Font; Text: pansichar; fg, bg: TSDL_Color): PSDL_Surface cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_RenderText_Shaded' {$ENDIF} {$ENDIF};
function TTF_RenderUTF8_Shaded(font: PTTF_Font; Text: pansichar; fg, bg: TSDL_Color): PSDL_Surface cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_RenderUTF8_Shaded' {$ENDIF} {$ENDIF};
function TTF_RenderUNICODE_Shaded(font: PTTF_Font; Text: PUInt16; fg, bg: TSDL_Color): PSDL_Surface cdecl;
...
{* Create an 8-bit palettized surface and render the given glyph at
   ...
   This function returns the new surface, or NULL if there was an error.
*}
function TTF_RenderGlyph_Shaded(font: PTTF_Font; ch: uint16; fg, bg: TSDL_Color): PSDL_Surface cdecl;
...
function TTF_RenderUNICODE_Blended(font: PTTF_Font; Text: PUInt16; fg: TSDL_Color): PSDL_Surface cdecl;
...
{* Create a 32-bit ARGB surface and render the given text at high quality,
   ...
   This function returns the new surface, or NULL if there was an error.
*}
function TTF_RenderText_Blended_Wrapped(font: PTTF_Font; Text: pansichar; fg: TSDL_Color; wrapLength: uint32): PSDL_Surface cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_RenderText_Blended_Wrapped' {$ENDIF} {$ENDIF};
function TTF_RenderUTF8_Blended_Wrapped(font: PTTF_Font; Text: pansichar; fg: TSDL_Color; wrapLength: uint32): PSDL_Surface cdecl;
  external TTF_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_TTF_RenderUTF8_Blended_Wrapped' {$ENDIF} {$ENDIF};
function TTF_RenderUNICODE_Blended_Wrapped(font: PTTF_Font; Text: PUInt16; fg: TSDL_Color; wrapLength: uint32): PSDL_Surface cdecl;
