...
function Mix_OpenAudio(frequency: integer; format: uint16; channels: integer; chunksize: integer): integer cdecl;
   ...
   *}
function Mix_AllocateChannels(numchans: integer): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_AllocateChannels' {$ENDIF} {$ENDIF};

  {* Find out what the actual audio device parameters are.
     This function returns 1 if the audio has been opened, 0 otherwise.
   *}
function Mix_QuerySpec(frequency: PInt; format: PUInt16; channels: PInt): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_QuerySpec' {$ENDIF} {$ENDIF};

{* Load a wave file or a music (.mod .s3m .it .xm) file *}
function Mix_LoadWAV_RW(src: PSDL_RWops; freesrc: integer): PMix_Chunk cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_LoadWAV_RW' {$ENDIF} {$ENDIF};
...
function Mix_LoadMUS_RW(src: PSDL_RWops; freesrc: integer): PMix_Music cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_LoadMUS_RW' {$ENDIF} {$ENDIF};

{* Load a music file from an SDL_RWop object assuming a specific format *}
function Mix_LoadMUSType_RW(src: PSDL_RWops; _type: TMix_MusicType; freesrc: integer): PMix_Music cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_LoadMUSType_RW' {$ENDIF} {$ENDIF};

{* Load a wave file of the mixer format from a memory buffer *}
function Mix_QuickLoad_WAV(mem: PUInt8): PMix_Chunk cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_QuickLoad_WAV' {$ENDIF} {$ENDIF};

{* Load raw audio data of the mixer format from a memory buffer *}
function Mix_QuickLoad_RAW(mem: PUInt8; len: uint32): PMix_Chunk cdecl;
...
function Mix_GetMusicDecoder(index: integer): pansichar cdecl;
  ...
  *}
function Mix_GetMusicType(music: TMix_Music): TMix_MusicType cdecl;
...
procedure Mix_SetPostMix(func: TMix_Func; arg: Pointer) cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_SetPostMix' {$ENDIF} {$ENDIF};

  {* Add your own music player or additional mixer function.
     If 'mix_func' is NULL, the default music player is re-enabled.
   *}
procedure Mix_HookMusic(func: TMix_Func; arg: Pointer) cdecl;
...
procedure Mix_HookMusicFinished(music_finished: PMix_Music_Finished) cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_HookMusicFinished' {$ENDIF} {$ENDIF};
...
procedure Mix_ChannelFinished(channel_finished: TMix_Channel_Finished) cdecl;
...
type
   ...
   *}
function Mix_RegisterEffect(chan: integer; f: TMix_EffectFunc_t; d: TMix_EffectDone_t; arg: Pointer): integer cdecl;
   ...
   *  Error messages can be retrieved from Mix_GetError().
   *}
function Mix_UnregisterEffect(channel: integer; f: TMix_EffectFunc_t): integer cdecl;
   ...
   *  Error messages can be retrieved from Mix_GetError().
   *}
function Mix_UnregisterAllEffects(channel: integer): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_UnregisterEffects' {$ENDIF} {$ENDIF};
...
const
   ...
   *  Error messages can be retrieved from Mix_GetError().
   *}
function Mix_SetPanning(channel: integer; left: uint8; right: uint8): integer cdecl;
   ...
   *  Error messages can be retrieved from Mix_GetError().
   *}
function Mix_SetPosition(channel: integer; angle: SInt16; distance: uint8): integer cdecl;
   ...
   *  Error messages can be retrieved from Mix_GetError().
   *}
function Mix_SetDistance(channel: integer; distance: uint8): integer cdecl;
...
//#endif
   ...
   *  Error messages can be retrieved from Mix_GetError().
   *}
function Mix_SetReverseStereo(channel: integer; flip: integer): integer cdecl;
...
{* end of effects API. --ryan. *}
   ...
   *}
function Mix_ReserveChannels(num: integer): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_ReverseChannels' {$ENDIF} {$ENDIF};
...
function Mix_GroupChannels(from: integer; _to: integer; tag: integer): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_GroupChannels' {$ENDIF} {$ENDIF};
  {* Finds the first available channel in a group of channels,
     returning -1 if none are available.
   *}
function Mix_GroupAvailable(tag: integer): integer cdecl;
...
function Mix_PlayChannelTimed(channel: integer; chunk: PMix_Chunk; loops: integer; ticks: integer): integer cdecl;
...
function Mix_FadeInMusic(music: PMix_Music; loops: integer; ms: integer): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_FadeInMusic' {$ENDIF} {$ENDIF};
function Mix_FadeInMusicPos(music: PMix_Music; loops: integer; ms: integer; position: double): integer cdecl;
...
function Mix_FadeInChannelTimed(channel: integer; chunk: PMix_Chunk; loops: integer; ms: integer; ticks: integer): integer cdecl;
...
function Mix_VolumeChunk(chunk: PMix_Chunk; volume: integer): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_VolumeChunk' {$ENDIF} {$ENDIF};
function Mix_VolumeMusic(volume: integer): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_VolumeMusic' {$ENDIF} {$ENDIF};

{* Halt playing of a particular channel *}
function Mix_HaltChannel(channel: integer): integer cdecl;
...
function Mix_HaltMusic: integer cdecl; external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_HaltMusic' {$ENDIF} {$ENDIF};
  ...
  *}
function Mix_ExpireChannel(channel: integer; ticks: integer): integer cdecl;
...
function Mix_FadeOutMusic(ms: integer): integer cdecl;
...
function Mix_FadingChannel(which: integer): TMix_Fading cdecl;
...
function Mix_PausedMusic: integer cdecl; external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_PausedMusic' {$ENDIF} {$ENDIF};
  ...
  *}
function Mix_SetMusicPosition(position: double): integer cdecl;
...
function Mix_SetMusicCMD(command: pansichar): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_SetMusicCMD' {$ENDIF} {$ENDIF};

{* Synchro value is set by MikMod from modules while playing *}
function Mix_SetSynchroValue(Value: integer): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_SetSynchroValue' {$ENDIF} {$ENDIF};
...
function Mix_SetSoundFonts(paths: pansichar): integer cdecl;
...
function Mix_EachSoundFont(func: TMix_SoundFunc; Data: Pointer): integer cdecl;
  external MIX_LibName {$IFDEF DELPHI} {$IFDEF MACOS} name '_MIX_EachSoundFont' {$ENDIF} {$ENDIF};

  {* Get the Mix_Chunk currently associated with a mixer channel
      Returns NULL if it's an invalid channel, or there's no chunk associated.
  *}
function Mix_GetChunk(channel: integer): PMix_Chunk cdecl;
